    ...
    <div className="outer">
      ...
      <div className="home-container ">
        ...
        <p>
          ...
          and training department in the college. This application helps to
          manage the student information with regards to the placements.
        </p>
        <p>
        ...
        <p>
          ...
          to various streams. The placement officer will clearly notify the
        ...
        <p>
          ...
          the portal. We can create a search engine for the administrator who
          can search for everything regarding students and the company. Earlier,
          It was difficult to communicate the information with the “N” number of
          students together about the placement drives. So the web application
          was designed which was easy and efficient to communicate the
          information to the students in a manual way.
        </p>
        ...
        <p>
          ...
          application will be filled by default and it cannot be changed. The
          job designation can be selected and the description will also be
        ...
        <p>
          Next, if the student has done any specializations (masters) the name
          of that should be mentioned. The number of years of bond or agreement
          the company would like to have with you will be mentioned. The date of
          the drive, the last date of submission of application and designation,
          Job descriptions, information about the company will be mentioned by
          default for all the students.
        </p>
        <img
          className="subHeadings-image"
        ...
        <p>
          The page shows the details of the list of students who have applied
          for the drive along with the date when they have applied. The applied
          students can attend the interview on the mentioned date. If students
          clear any of the rounds in the interview and further get shortlisted
          for the next round their names will be mentioned in the list.
        </p>
        <p>
